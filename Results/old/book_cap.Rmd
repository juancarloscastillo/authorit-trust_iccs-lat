...
Este capítulo se focaliza en el nivel individual para comprender el rol que juega el nivel de conocimiento cívico y las creencias autoritarias sobre los niveles de confianza institucional.

¿cómo se relaciona el nivel de conocimiento cívico con la evaluación de las instituciones?¿cómo se relaciona el nivel de creencias autoritarias con la evaluación de las instituciones?¿qué rol juega el nivel de conocimiento cívico para entender mejor ésta relación?

\break

# Theoretical Backgroung

Un sustento importante de los sistemás democráticos es la confianza que los ciudadanos a la institucionalidad que la organiza (cita) en el marco de un sistema de creencias consistente con sus principios [@lipset_social_1959]. En ese contexto, se espera que los ciudadanos desarrollen un conjunto de creencias y actitudes relevantes para participar del espacio democrático. Entre las creencias y actitudes consistentes con la ciudadanía democrática, la des-confianza institucional [@latinobarometro_informe_2018] y las presencia-ausencia de ideas autoritarias [@altemeyer_authoritarians_2008] han sido vistas como un aspectos claves de los procesos políticos an America Latina. Entender el desarrollo actitudes de creencias y actitudes in-consistentes con la ciudadanía democrática es particularmente relevante en America Latina debido a los bajos niveles de confianza y la presencia histórica de creencias y prácticas autoritarias.
...
El apoyo a las prácticas autoritarias puede ser vinculado fácilmente  con el concepto psilógico de autoritarismo, ampliamente utilizado en psicología política. A partir de esta literatura, se ha vinulado el auotirtarias con el continuo izquierda derecha.En esa asociación, las personas de drecha tienden a presentar mayores niveles de auotirtarismo y las personas de izquierda menos. Es sentido, es posible pensar que la posición política también esta juegando un rol sobre la evaluación que estos hacen de las institciones. No es posible despejar ese aspecto con estos pero queda abierta la pregunta sobre el rol que juega la posición política sobre la evaluación institucional.
...
```{r echo=FALSE, fig.align='center' }
library(knitr) 
include_graphics("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g2.png", dpi=NA)
```
...
```{r echo=FALSE, fig.align='center' }
library(knitr) 
include_graphics("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g4.png", dpi=NA)
```
...
```{r echo=FALSE, fig.align='center' }
library(knitr) 
include_graphics("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g5.png", dpi=NA)
```
...
```{r echo=FALSE, fig.align='center' }
library(knitr) 
include_graphics("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g6.png", dpi=NA)
```
...
```{r echo=FALSE, fig.align='center' }
library(knitr) 
include_graphics("C:/Users/DM/Dropbox (Personal)/book_authoritarianism/Resultados/graph/g7.png", dpi=NA)
```
